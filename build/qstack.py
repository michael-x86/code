...
mon("sendkey ret",0.4)
time.sleep(0.5)
r=mon("info registers",0.4)
esp=re.search(r"ESP=([0-9a-fA-F]+)",r)
print("ESP=",esp.group(1) if esp else "?")
print("--- stack dump (esp .. esp+0x100) ---")
base=int(esp.group(1),16) if esp else 0xc010cf00
print(mon(f"x /96wx 0x{base:08x}",0.6))
