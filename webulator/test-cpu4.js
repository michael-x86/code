...
console.log('context.module.exports:', Object.keys(context.module.exports));
...
console.log('context.X86CPU:', typeof context.X86CPU);
console.log('context.module.exports:', typeof context.module.exports);
...
mem.write8(testAddr + 5, 0x8B);  // MOV r32, r/m32
...
cpu.step();
const expectedEip = testAddr + 7 + 5 + 0x10;
...
cpu.step();
console.log(`ESP after PUSH = 0x${cpu.regs.esp.toString(16).padStart(8, '0')} (expected 0x200000 - 4 = 0x1FFFFC)`);
...
console.log(`VGA[0] = '${String.fromCharCode(mem.read8(0xB8000))}' (expected 'H')`);
